...
/**
 * Sistemska operacija koja na tabli postavlja oznake za broj mina oko svakog
 * polja, osim za polja na kojima je mina.
 * 
 * @author Milos Brkic
 * @version 1.0
 */
public class SOOznacavanjePolja {
	 ...
	 *            Dimenzija table Y.
	 * @param polja
	 *            Matrica polja na kojoj se postavljaju oznake.
	 */
