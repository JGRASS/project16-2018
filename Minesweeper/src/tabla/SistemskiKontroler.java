...
/**
 * Sistemski kontroler iz kog se pozivaju sistemske operacije logickog nivoa
 * aplikacije.
 * 
 * @author Milos Brkic
 * @version 1.0
...
public class SistemskiKontroler {
	...
	/**
	 * Konstruktor koji kreira pocetnu tablu i ucitava rang listu iz fajla
	 * ukoliko postoji.
	 */
	 ...
	 *            Dimenzija table Y.
	 * @param brMina
	 *            Broj mina koji se postavlja na tablu.
	 */
	...
	/**
	 * Azurira stanje tabla u zavisnosti od otvorenog polja i odredjuje stanje
	 * igre.
	 * 
	 * @param x
	 ...
	 * 
	 * @param xp
	 *            Koordinata X prvog protisnutog polja.
	 * @param yp
	 *            Koordinata Y prvog protisnutog polja.
	 */
